...
import { Input } from "@/components/ui/input"; // если нет — добавь через shadcn
...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen bg-slate-950 flex items-center justify-center px-6">
      <div className="max-w-md w-full bg-slate-900 rounded-3xl p-10 border border-cyan-500/20">
        ...
        <div className="space-y-6">
          ...
          <Button
            onClick={handleAuth}
            disabled={loading}
            className="w-full py-7 text-lg bg-cyan-500 hover:bg-cyan-400 text-black"
          >
